...
function getCocktailInfo(cocktailNo: number): string {
  ...
  cocktailDataListInit.set(1, { id: 1, name: "カクテル1", price: 1200 });
  cocktailDataListInit.set(2, { id: 2, name: "カクテル2", price: 1500 });
  cocktailDataListInit.set(3, { id: 3, name: "カクテル3", price: 1100 });
  cocktailDataListInit.set(4, { id: 4, name: "カクテル4", price: 1500 });
